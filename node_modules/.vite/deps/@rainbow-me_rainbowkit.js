...
import {
  ...
  useSignMessage,
  useSwitchChain
} from "./chunk-ZL4RP4LQ.js";
import {
  http,
  withRetry,
  withTimeout
} from "./chunk-E23W6TJO.js";
import "./chunk-NV3OTTC7.js";
import {
  ResourceUnavailableRpcError,
  SwitchChainError,
  UserRejectedRequestError
} from "./chunk-CHDJBKVG.js";
import {
  getAddress,
  isAddress,
  numberToHex
} from "./chunk-NQBK6CGJ.js";
import "./chunk-FMWNB5XA.js";
...
import {
  ...
  __spreadArray,
  init_tslib_es6
} from "./chunk-II24DDMM.js";
import {
  useQuery
} from "./chunk-DZV4TFVB.js";
import "./chunk-DOUTYWKU.js";
import {
  require_react_dom
} from "./chunk-V44PP5ZF.js";
import {
  require_react
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-4L2Z4TIZ.js");
...
function version3(parameters) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-3OSGRAKS.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-KFPRXJ6L.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-WYV6PG55.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-4BRUFI3T.js");
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    ...
    case "en":
    case "en-US":
      return (await import("./en_US-762U7H2X-OG6SXV2Y.js")).default;
    case "es":
    case "es-419":
    ...
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-PML3AXSR-UAVHAUSU.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
